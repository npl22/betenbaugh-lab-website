...
///////////////////////////////////////////////////////////////////////////////////////
$sql = "SELECT * FROM `proteinDataFish` WHERE `Name` = '$ProteinID'";
...
<h2>Identified <em>N</em>-Linked Glyco-Peptides</h2>
      <table style="width: 800px;" cellpadding="0" cellspacing="0">
        <tbody><tr bgcolor="#cccccc">
          ...
          <td width="222"><strong>Identified Sequence</strong></td>
          <td width="99"><strong>Enzyme Used</strong></td>
          <td width="83"><strong>Observed Mass</strong></td>
          <td width="85"><strong>Predicted Mass</strong></td>
          <td width="68"><strong>Charge&nbsp;</strong></td>
...
$sql = "SELECT * FROM `sequenceDataFish` WHERE `ReferenceID` = '$Name' ORDER BY Location";
$result = mysql_query($sql);
